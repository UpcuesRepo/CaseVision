...
$(document).ready((function(){var e,t,o,a;$(".add-after").after('<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.33366 2.5L3.75033 7.08333L1.66699 5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'),$(".add-after2").after('<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.33366 2.5L3.75033 7.08333L1.66699 5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>');var n=1,r=$("fieldset").length;function i(e){var t=parseFloat(100/r)*e;t=t.toFixed(),$(".progress-bar").css("width",t+"%")}function s(e,t){let o=e.querySelector(".drop-zone__thumb");if(e.querySelector(".drop-zone__prompt")&&e.querySelector(".drop-zone__prompt").remove(),o||(o=document.createElement("div"),o.classList.add("drop-zone__thumb"),e.appendChild(o)),o.dataset.label=t.name,t.type.startsWith("image/")){const e=new FileReader;e.readAsDataURL(t),e.onload=()=>{o.style.backgroundImage=`url('${e.result}')`}}else o.style.backgroundImage=null}i(n),$(".next").click((function(){e=$(this).parent(),t=$(this).parent().next(),$("#progressbar li").eq($("fieldset").index(t)).addClass("active"),t.show(),e.animate({opacity:0},{step:function(o){a=1-o,e.css({display:"none",position:"relative"}),t.css({opacity:a})},duration:500}),i(++n)})),$(".previous").click((function(){e=$(this).parent(),o=$(this).parent().prev(),$("#progressbar li").eq($("fieldset").index(e)).removeClass("active"),o.show(),e.animate({opacity:0},{step:function(t){a=1-t,e.css({display:"none",position:"relative"}),o.css({opacity:a})},duration:500}),i(--n)})),$(".submit").click((function(){return!1})),$("#file-upload").change((function(){var e=this.value.match(/([^\/\\]+)$/)[1];$("#filename").text(e)})),$(".file-upload").change((function(){var e=this.value.match(/([^\/\\]+)$/)[1];$(".filename").text(e)})),document.querySelectorAll(".drop-zone__input").forEach((e=>{const t=e.closest(".drop-zone");t.addEventListener("click",(t=>{e.click()})),e.addEventListener("change",(o=>{e.files.length&&s(t,e.files[0])})),t.addEventListener("dragover",(e=>{e.preventDefault(),t.classList.add("drop-zone--over")})),["dragleave","dragend"].forEach((e=>{t.addEventListener(e,(e=>{t.classList.remove("drop-zone--over")}))})),t.addEventListener("drop",(o=>{o.preventDefault(),o.dataTransfer.files.length&&(e.files=o.dataTransfer.files,s(t,o.dataTransfer.files[0])),t.classList.remove("drop-zone--over")}))}));[...document.querySelectorAll('[data-bs-toggle="tooltip"]')].map((e=>new bootstrap.Tooltip(e)))}));