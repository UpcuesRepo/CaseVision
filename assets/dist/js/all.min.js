...
$(document).ready((function(){function e(e,t){let a=e.querySelector(".drop-zone__thumb");if(e.querySelector(".drop-zone__prompt")&&e.querySelector(".drop-zone__prompt").remove(),a||(a=document.createElement("div"),a.classList.add("drop-zone__thumb"),e.appendChild(a)),a.dataset.label=t.name,t.type.startsWith("image/")){const e=new FileReader;e.readAsDataURL(t),e.onload=()=>{a.style.backgroundImage=`url('${e.result}')`}}else a.style.backgroundImage=null}$(".add-after").after('<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.33366 2.5L3.75033 7.08333L1.66699 5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'),$("#file-upload").change((function(){var e=this.value.match(/([^\/\\]+)$/)[1];$("#filename").text(e)})),document.querySelectorAll(".drop-zone__input").forEach((t=>{const a=t.closest(".drop-zone");a.addEventListener("click",(e=>{t.click()})),t.addEventListener("change",(o=>{t.files.length&&e(a,t.files[0])})),a.addEventListener("dragover",(e=>{e.preventDefault(),a.classList.add("drop-zone--over")})),["dragleave","dragend"].forEach((e=>{a.addEventListener(e,(e=>{a.classList.remove("drop-zone--over")}))})),a.addEventListener("drop",(o=>{o.preventDefault(),o.dataTransfer.files.length&&(t.files=o.dataTransfer.files,e(a,o.dataTransfer.files[0])),a.classList.remove("drop-zone--over")}))}));[...document.querySelectorAll('[data-bs-toggle="tooltip"]')].map((e=>new bootstrap.Tooltip(e)))}));const menuBtn=document.getElementById("menu-btn"),sidebar=document.getElementById("sidebar");menuBtn.onclick=function(){-1===sidebar.className.indexOf("collapsed")?(sidebar.className+=" collapsed",$(".content-part").addClass("open"),$(".arrow").addClass("rotate")):(sidebar.className="sidebar",$(".content-part").removeClass("open"),$(".arrow").removeClass("rotate"))};