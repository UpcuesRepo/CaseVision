...
$(".add-after").after('<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.33366 2.5L3.75033 7.08333L1.66699 5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'),$("#file-upload").change((function(){var e=this.value.match(/([^\/\\]+)$/)[1];$("#filename").text(e)}));var multipleCancelButton=new Choices("#choices-multiple-remove-button",{removeItemButton:!0,maxItemCount:2,searchResultLimit:5,renderChoiceLimit:5});function updateThumbnail(e,t){let o=e.querySelector(".drop-zone__thumb");if(e.querySelector(".drop-zone__prompt")&&e.querySelector(".drop-zone__prompt").remove(),o||(o=document.createElement("div"),o.classList.add("drop-zone__thumb"),e.appendChild(o)),o.dataset.label=t.name,t.type.startsWith("image/")){const e=new FileReader;e.readAsDataURL(t),e.onload=()=>{o.style.backgroundImage=`url('${e.result}')`}}else o.style.backgroundImage=null}document.querySelectorAll(".drop-zone__input").forEach((e=>{const t=e.closest(".drop-zone");t.addEventListener("click",(t=>{e.click()})),e.addEventListener("change",(o=>{e.files.length&&updateThumbnail(t,e.files[0])})),t.addEventListener("dragover",(e=>{e.preventDefault(),t.classList.add("drop-zone--over")})),["dragleave","dragend"].forEach((e=>{t.addEventListener(e,(e=>{t.classList.remove("drop-zone--over")}))})),t.addEventListener("drop",(o=>{o.preventDefault(),o.dataTransfer.files.length&&(e.files=o.dataTransfer.files,updateThumbnail(t,o.dataTransfer.files[0])),t.classList.remove("drop-zone--over")}))}));const menuBtn=document.getElementById("menu-btn"),sidebar=document.getElementById("sidebar");menuBtn.onclick=function(){-1===sidebar.className.indexOf("collapsed")?(sidebar.className+=" collapsed",$(".content-part").addClass("open"),$(".arrow").addClass("rotate")):(sidebar.className="sidebar",$(".content-part").removeClass("open"),$(".arrow").removeClass("rotate"))};const tooltipTriggerList=document.querySelectorAll('[data-bs-toggle="tooltip"]'),tooltipList=[...tooltipTriggerList].map((e=>new bootstrap.Tooltip(e)));