...
const menuBtn=document.getElementById("menu-btn"),sidebar=document.getElementById("sidebar");menuBtn.onclick=function(){-1===sidebar.className.indexOf("collapsed")?sidebar.className+=" collapsed":sidebar.className="sidebar"};