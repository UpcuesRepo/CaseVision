...
$(document).ready((function(){$("#choices-multiple-remove-button").choices({removeItemButton:!0,maxItemCount:5,searchResultLimit:5,renderChoiceLimit:5}),$("#choices-multiple-remove-button-2").choices({removeItemButton:!0,maxItemCount:10,searchResultLimit:5,renderChoiceLimit:5})})),$(document).ready((function(){function e(e,t){let o=e.querySelector(".drop-zone__thumb");if(e.querySelector(".drop-zone__prompt")&&e.querySelector(".drop-zone__prompt").remove(),o||(o=document.createElement("div"),o.classList.add("drop-zone__thumb"),e.appendChild(o)),o.dataset.label=t.name,t.type.startsWith("image/")){const e=new FileReader;e.readAsDataURL(t),e.onload=()=>{o.style.backgroundImage=`url('${e.result}')`}}else o.style.backgroundImage=null}$(".add-after").after('<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.33366 2.5L3.75033 7.08333L1.66699 5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'),$("#file-upload").change((function(){var e=this.value.match(/([^\/\\]+)$/)[1];$("#filename").text(e)})),document.querySelectorAll(".drop-zone__input").forEach((t=>{const o=t.closest(".drop-zone");o.addEventListener("click",(e=>{t.click()})),t.addEventListener("change",(r=>{t.files.length&&e(o,t.files[0])})),o.addEventListener("dragover",(e=>{e.preventDefault(),o.classList.add("drop-zone--over")})),["dragleave","dragend"].forEach((e=>{o.addEventListener(e,(e=>{o.classList.remove("drop-zone--over")}))})),o.addEventListener("drop",(r=>{r.preventDefault(),r.dataTransfer.files.length&&(t.files=r.dataTransfer.files,e(o,r.dataTransfer.files[0])),o.classList.remove("drop-zone--over")}))}));[...document.querySelectorAll('[data-bs-toggle="tooltip"]')].map((e=>new bootstrap.Tooltip(e)))}));const menuBtn=document.getElementById("menu-btn"),sidebar=document.getElementById("sidebar");menuBtn.addEventListener("click",(function(){sidebar.classList.contains("collapsed")?(sidebar.classList.remove("collapsed"),document.querySelectorAll(".content-part").forEach((function(e){e.classList.remove("open")})),document.querySelectorAll(".arrow").forEach((function(e){e.classList.remove("rotate")}))):(sidebar.classList.add("collapsed"),document.querySelectorAll(".content-part").forEach((function(e){e.classList.add("open")})),document.querySelectorAll(".arrow").forEach((function(e){e.classList.add("rotate")})))}));